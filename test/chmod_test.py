...
class ChmodTest(MiniClusterTestBase):
    def test_onepath(self):
        list(self.client.chmod(['/dir1'], 511))
    ...
    def test_multipath(self):
        list(self.client.chmod(['/dir1', '/zerofile'], 511))
