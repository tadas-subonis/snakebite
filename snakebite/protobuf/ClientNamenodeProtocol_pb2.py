...
_GETADDITIONALDATANODEREQUESTPROTO = descriptor.Descriptor(
    ...
    fields=[
        ...
        descriptor.FieldDescriptor(
            ...
            options=None),
        descriptor.FieldDescriptor(
            name='numAdditionalNodes', full_name='hadoop.hdfs.GetAdditionalDatanodeRequestProto.numAdditionalNodes',
            index=4,
...
_GETSNAPSHOTTABLEDIRLISTINGRESPONSEPROTO = descriptor.Descriptor(
    ...
    fields=[
        descriptor.FieldDescriptor(
            name='snapshottableDirList',
            full_name='hadoop.hdfs.GetSnapshottableDirListingResponseProto.snapshottableDirList', index=0,
            number=1, type=11, cpp_type=10, label=1,
            has_default_value=False, default_value=None,
            message_type=None, enum_type=None, containing_type=None,
            is_extension=False, extension_scope=None,
...
_GETDATAENCRYPTIONKEYRESPONSEPROTO = descriptor.Descriptor(
    ...
    fields=[
        descriptor.FieldDescriptor(
            name='dataEncryptionKey', full_name='hadoop.hdfs.GetDataEncryptionKeyResponseProto.dataEncryptionKey',
            index=0,
            number=1, type=11, cpp_type=10, label=1,
            has_default_value=False, default_value=None,
            message_type=None, enum_type=None, containing_type=None,
...
_GETSNAPSHOTTABLEDIRLISTINGRESPONSEPROTO.fields_by_name[
    'snapshottableDirList'].message_type = hdfs_pb2._SNAPSHOTTABLEDIRECTORYLISTINGPROTO
